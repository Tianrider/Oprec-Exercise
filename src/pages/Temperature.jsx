...
const Temperature = () => {
    ...
    const handleButtonClick = () => {
        ...
        setTimeout(() => {
            setStatus(null)
          setEquation('Result: ');
          setResult(`${value} °${selectedBaseTemp} = ${result} °${selectedTargetTemp}`);
        }, 2000); 
    }
    ...
    return (
        <div className="temperature">
            <nav className='fixed-top'>
                <a href='/Oprec-Exercise/'><RiHomeLine className='home-button'></RiHomeLine></a>
            </nav>
            ...
            onSubmit={(e) => e.preventDefault()}>
                ...
                <select className="form-select-one form-select" ref={baseTempRef} defaultValue={'C'}>
                ...
                <div className="col-2 d-flex justify-content-center">
                <select className="form-select-two form-select" ref={targetTempRef} defaultValue={'F'}>                                         
                    <option value="K">°K (Kelvin)</option>
                    <option value="C">°C (Celcius)</option>
                    <option value="F">°F (Fahrenheit)</option>
                    <option value="R">°Re (Reamur)</option>
            ...
            <div className="result-text-container">
                ...
                <h5 className="result-text">{result !== null ? result : 'Waiting for you....'}</h5>
            </div>
